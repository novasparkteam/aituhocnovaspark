/* ============================================================
   NOVA SPARK — Shared JavaScript Module
   ============================================================ */
...
const NOVA_SPARK = {
    ...
    teamName: 'Nova Spark',
    teamLead: 'Mai Đỗ Hà My',
    teamMember: 'Trần Đình Mạnh Phong',
...
const NS_CHATBOT_SYSTEM_PROMPT = `Bạn là Nova Spark Study Assistant — trợ lý AI thuộc dự án Nova Spark.
Đội trưởng: Mai Đỗ Hà My. Thành viên: Trần Đình Mạnh Phong.
Quy tắc:
